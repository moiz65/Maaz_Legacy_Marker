...
const Login = () => {
    ...
    const [errors, setErrors] = useState<FormInstance>({
        email: '',
        password: ''
    });
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        setErrors(validationErrors as FormInstance);
    ...
    return (
        <>
            <div className="w-full grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
                <div className="flex items-center justify-center bg-[#F5F5F5] lg:p-[50px] md:p-[50px] py-[80px]">
                    <div className="w-full md:w-[75%] lg:w-[75%] rounded-[30px] bg-[white] p-8">
                        <form action="" onSubmit={handleSubmit}>
                            <h2 className="text-4xl font-[poppins] text-center font-bold leading-normal mb-2 text-[#4C4448] mb-2">Log In</h2>
                            <p className="text-[#62585D] font-[poppins] text-center">Login to continue with LegacyMarker</p>
                            <div className="flex flex-col gap-[20px] pt-[40px] px-[20px]">
                                <div className="">
                                    <label htmlFor="email" className="font-[poppins] block text-gray-700 text-sm font-semibold mb-2">Email</label>
                                    <input
                                        type="text"
                                        id="email"
                                        name="email"
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInput}
                                        // onChange={(e) => {
                                        //     // Call handleInput function only if the input value is being changed
                                        //     // setCurrentPassword(e.target.value);
                                        //     handleInput; // Update password state
                                        // }}
                                ...
                                {errors.password &&
                                    <div id="alert-border-2" className="flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800" role="alert">
                                        ...
                                        <button type="button" onClick={dissmiss2} className="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-border-2" aria-label="Close">
                                            <span className="sr-only">Dismiss</span>
                                            <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                            </svg>
                                ...
                                <div className="flex justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <label htmlFor="checkbox" className="ml-2 text-[14px] text-gray-700 font-[poppins]">Remember me</label>
                                    </div>
                                    <div className="">
                                        <Link to="">
                                ...
                                <p className="text-[#62585D] font-[poppins] text-center">Don’t have an account? <Link to="/register"><span className="text-[#2F80ED]">Register here</span></Link></p>
                            </div>
                        </form>
                    </div>
                </div>
...
export default withLoadingsppiner(Login);